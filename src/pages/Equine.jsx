  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8] font-sans text-[#1C1C1A]">
      ...
      <section className="bg-[#1C1C1A] text-white py-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-0 divide-y divide-white/10">
            {[
              { icon: Truck, title: "Go-bag lives on the trailer", desc: "Keep your equine go-bag — Coggins papers, medications, halter, lead rope — stored on the horse trailer itself. When it's time to go, you grab and leave without doubling back to the house." },
              { icon: AlertTriangle, title: "Never re-enter an evacuation zone", desc: "Once you've left, do not return for anything. Conditions can deteriorate instantly and roads close behind you. What you have with you is enough — lives are not worth retrieving possessions." },
              { icon: Shield, title: "If it won't fit or you're out of time", desc: "Sink valuables into a pool or livestock water tub. Leave what you can't take in a storm shelter, basement, or the most fire-resistant structure on the property. Insurance replaces things — it can't replace a life." },
              { icon: Heart, title: "Last resort: turn them loose", desc: "If a horse absolutely will not load and you've exhausted every option, release them from a pasture or open barn — but close the gate or door behind you so they can't trap themselves back inside. Force them to flee on foot. A loose horse has a chance; one left in a burning barn has none." },
      ...
      <section className="relative h-[55vh] min-h-[380px] overflow-hidden">
        <img
          src="https://media.base44.com/images/public/69dc170f0871ac017d79debb/26c0efe73_generated_image.png"
          alt=""
          loading="lazy"
      ...
      <section className="relative overflow-hidden bg-[#1C1C1A]">
        <div className="absolute inset-0 bg-cover bg-center opacity-15" style={{ backgroundImage: "url('https://media.base44.com/images/public/69dc170f0871ac017d79debb/f771d61ca_generated_image.png')" }} />
