...
const _trackedDonationComplete = new Set();
      ...
      items: [
        {
          ...
          description:
            "One-time donation to support free emergency preparedness",
    ...
    return (
      <div className="min-h-screen bg-[#F5F0E8] flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <h1 className="font-serif text-4xl font-bold text-[#1C1C1A] mb-3">
            Thank you.
          </h1>
          <p className="text-[#1C1C1A]/60 font-sans leading-relaxed mb-8">
            Your contribution directly funds the tools and infrastructure that
            keep RallyPack free for families who need it most.
          </p>
          <a
            href="/"
            className="inline-flex items-center gap-2 bg-[#D64A2E] text-white font-sans font-semibold px-8 py-3 hover:bg-[#be3f25] transition-colors text-sm tracking-widest uppercase"
          >
            Back to RallyPack
          </a>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8]">
        ...
        <div className="bg-white border border-[#D8D2C6] p-8 shadow-sm">
          <div className="flex items-end justify-between mb-3">
            ...
            <div className="text-right">
              <p className="font-serif text-3xl font-bold text-[#D64A2E]">
                {progressLoading ? "—" : `${progressPct}%`}
              </p>
              <p className="text-xs text-[#8A8577] font-sans">
                {progress?.donor_count || 0} donors
              </p>
            </div>
          </div>
          <div className="w-full h-3 bg-[#F5F0E8] rounded-full overflow-hidden">
            <div
              className="h-full bg-[#D64A2E] rounded-full transition-all duration-500"
      ...
      <div className="max-w-3xl mx-auto px-4 mb-12">
        <p className="text-[10px] uppercase tracking-[0.3em] text-[#D64A2E] font-sans mb-3 text-center">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-baseline justify-between gap-4">
                    <h3 className="font-sans font-semibold text-sm text-[#1C1C1A]">
                      {cost.label}
                    </h3>
                  ...
                  <p className="text-xs text-[#1C1C1A]/50 font-sans mt-1">
                    {cost.description}
                  </p>
                </div>
              </div>
      ...
      <div className="max-w-lg mx-auto px-4 py-12">
        <div className="bg-white border border-[#D8D2C6] p-8">
          <h2 className="font-serif text-2xl font-bold text-[#1C1C1A] mb-2">
            Make a contribution
          </h2>
          <p className="text-sm text-[#1C1C1A]/50 font-sans mb-6">
            Every dollar goes toward keeping RallyPack free and operational.
          </p>
          ...
          <div className="mb-6">
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#1C1C1A]/40 font-sans text-sm">
                $
              </span>
              <input
                type="number"
