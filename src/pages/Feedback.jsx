  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8] font-sans text-[#1C1C1A]">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        {/* Title */}
        <div className="mb-12">
          <p className="text-[10px] uppercase tracking-[0.25em] text-[#D64A2E] font-sans mb-3">
            Beta Program
          </p>
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-[#1C1C1A] mb-4">
            Send Feedback
          </h1>
          <p className="text-muted-foreground font-sans max-w-xl leading-relaxed">
            RallyPack is in active beta. Your feedback directly shapes the
            product — we read every submission.
          </p>
        </div>
          ...
          {[
            {
              icon: Bug,
              title: "Found a bug?",
              desc: "Tell us exactly what happened and we'll fix it fast.",
            },
            {
              icon: Lightbulb,
              title: "Have an idea?",
              desc: "Feature requests from real users drive our roadmap.",
            },
            {
              icon: Star,
              title: "Love something?",
              desc: "Let us know what's working — we'll protect it.",
            },
          ].map(({ icon: Icon, title, desc }) => (
            <div
              key={title}
              className="border border-[#D8D2C6] rounded p-5 bg-white"
            >
              <Icon className="w-5 h-5 text-[#D64A2E] mb-3" />
              <h2 className="font-serif text-base font-bold text-[#1C1C1A] mb-1">
                {title}
              </h2>
              <p className="text-xs text-[#1C1C1A]/60 leading-relaxed font-sans">
                {desc}
              </p>
            </div>
          ))}
        ...
        <div className="bg-[#1C1C1A] rounded p-8 text-white">
          <p className="text-[10px] uppercase tracking-[0.25em] text-[#D64A2E] font-sans mb-2">
            Your Voice
          </p>
            ...
            <div className="flex items-center gap-3 bg-green-900/40 border border-green-600/40 rounded p-5">
              ...
              <div>
                ...
                <p className="text-sm text-white/60 font-sans mt-0.5">
                  Thank you — we'll review it and may follow up if you provided
                  your email.
                </p>
              </div>
            </div>
