...
export default function Infant() {
  ...
  const heroUrl = useHeroShot("infant");
  const editorialUrl = useHeroShot("infant_editorial");
  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8] font-sans text-[#1C1C1A]">
      ...
      <section className="relative h-[50vh] min-h-[340px] overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-[center_30%]" style={{ backgroundImage: `url('${editorialUrl}')` }} />
