...
const BLANK = {
  item_name: "",
  item_type: "valuable_asset",
  description: "",
  tracking_id: "",
  tracking_device: "airtag",
...
export default function TrackedItems() {
  ...
  const openEdit = (item) => {
    setForm({ ...item, purchase_value: item.purchase_value || "" });
    setEditing(item);
    setShowForm(true);
  };
  ...
  const handleSave = async () => {
    ...
    if (editing) {
      ...
      if (typeof pendo !== "undefined") {
        pendo.track("tracked_item_added", {
          item_type: data.item_type || "",
          tracking_device: data.tracking_device || "",
          has_insurance_policy: !!data.insurance_policy_number,
          has_purchase_value: !!data.purchase_value,
          associated_entity_type: data.associated_entity_type || "none",
        });
      }
    }
    setShowForm(false);
  ...
  const typeLabel = (val) =>
    ITEM_TYPES.find((t) => t.value === val)?.label || val;
  const deviceLabel = (val) =>
    DEVICES.find((d) => d.value === val)?.label || val;
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            AirTags, microchips & assets for insurance claims
          </p>
        </div>
        ...
        <Card className="text-center py-16">
          <CardContent>
            ...
            <p className="text-muted-foreground">
              No tracked items yet. Add your first AirTag or microchip.
            </p>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {item.tracking_device && (
                        <Badge variant="secondary">
                          {deviceLabel(item.tracking_device)}
                        </Badge>
                      )}
                      {!item.active && (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1 mt-3 text-sm">
                      ...
                      {item.purchase_value && (
                        <div className="flex items-center gap-1 text-muted-foreground">
                          ...
                          {Number(item.purchase_value).toLocaleString()} value
                        </div>
                      )}
      ...
      <Dialog open={showForm} onOpenChange={setShowForm}>
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {editing ? "Edit Tracked Item" : "Add Tracked Item"}
            </DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-4 py-2">
            <div>
              ...
              <Input
                ...
                placeholder="e.g. Max's Collar, MacBook Pro"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <Select
                  value={form.tracking_device}
                  onValueChange={(v) =>
                    setForm((f) => ({ ...f, tracking_device: v }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, tracking_id: e.target.value }))
                }
                placeholder="Serial or chip number"
              />
            </div>
            ...
            <div>
              ...
              <Select
                value={form.associated_entity_id || "none"}
                onValueChange={(v) =>
                  setForm((f) => ({
                    ...f,
                    associated_entity_id: v === "none" ? "" : v,
                    associated_entity_type: v === "none" ? "none" : "pet",
                  }))
                }
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, last_known_address: e.target.value }))
                }
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setForm((f) => ({ ...f, purchase_value: e.target.value }))
                  }
                  placeholder="0.00"
                />
              </div>
