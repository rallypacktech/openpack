  ...
  useEffect(() => {
    const loadUser = async () => {
      try {
        ...
        const publicPages = ["Home", "PrivacyPolicy", "TermsAndConditions", "LearnMore", "ReadinessQuiz", "Shopping", "Equine", "Canine", "Feline", "Infant", "Avian", "Reptile", "BusinessOnboarding", "Donate", "AffiliatePartnerPolicy", "Feedback"];
