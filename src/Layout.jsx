              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div className="pt-8 md:pt-0 border-t md:border-t-0 border-border">
                  <nav className="space-y-2" aria-label="Climate resources">
                    ...
                    <h3 className="text-xs uppercase tracking-widest font-sans font-semibold text-muted-foreground mb-2 mt-4 py-2">By Species</h3>
                ...
                <div className="pt-8 md:pt-0 border-t md:border-t-0 border-border">
                  ...
                  <nav className="space-y-2" aria-label="Legal navigation">
                    ...
                    <h3 className="text-xs uppercase tracking-widest font-sans font-semibold text-muted-foreground mb-2 mt-4 py-2">Contact</h3>
