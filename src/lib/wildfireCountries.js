// =============================================================================
// Frontend copy of the master country list for wildfire data.
// Mirrors base44/shared/wildfireCountries.ts (single source of truth for
// backend functions) — keep both in sync when adding countries or sources.
// Self-contained because the browser cannot import backend shared .ts modules.
// =============================================================================
...
export const EFFIS_COUNTRY_CODES = new Set([
  // Europe
...
export const isEffisCountry = (code) => EFFIS_COUNTRY_CODES.has(code);
