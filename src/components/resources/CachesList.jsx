  ...
  const handleSave = async () => {
    if (editingCache) {
      ...
      if (typeof pendo !== "undefined") {
        pendo.track("emergency_cache_created", {
          cache_name: formData.name,
          cache_type: formData.cache_type,
        ...
        <div className="flex gap-2">
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>
                  {editingCache ? "Edit" : "Add"} Emergency Cache
                </DialogTitle>
              </DialogHeader>
              <div className="space-y-4 mt-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, cache_type: e.target.value })
                    }
                  >
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-500">
              No caches yet. Add your first emergency cache!
            </p>
          </CardContent>
        </Card>
      )}
