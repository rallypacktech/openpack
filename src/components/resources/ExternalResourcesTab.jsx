...
const RESOURCE_CATEGORIES = [
  ...
  },
  {
    ...
    resources: [
      ...
      { name: "RedRover Relief", desc: "Grants and volunteer deployment for emergency animal sheltering during disasters. Helps families with urgent veterinary costs after emergencies.", url: "https://redrover.org", icon: "🤝" },
