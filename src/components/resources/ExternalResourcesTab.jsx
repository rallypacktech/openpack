...
const RESOURCE_CATEGORIES = [
  ...
  {
    id: "animal_welfare",
    label: "Animal Welfare & Pet Emergency",
    icon: Heart,
    color: "text-amber-700",
    bg: "bg-amber-50",
    border: "border-amber-200",
    resources: [
      { name: "NARS — National Animal Rescue & Sheltering", desc: "National coalition coordinating animal rescue, sheltering, and reunification during disasters. Resources for shelters and pet owners.", url: "https://nationalanimalrescue.org", icon: "🐾" },
      { name: "HSUS — Humane Society of the United States", desc: "Disaster response team rescues and shelters animals affected by floods, wildfires, and hurricanes. Pet preparedness guides available.", url: "https://www.humanesociety.org/resources/disaster-preparedness-pets", icon: "🐕" },
      { name: "ASPCA Disaster Response", desc: "ASPCA deploys field teams for animal rescue, emergency sheltering, and pet food distribution during disasters. Pet evacuation planning guides.", url: "https://www.aspca.org/pet-care/pet-disaster-preparedness", icon: "🐱" },
      { name: "RedRover Relief", desc: "Volunteer deployment for emergency animal sheltering during disasters. Sign up to help at emergency shelters nationwide.", url: "https://redrover.org/relief/", icon: "🤝" },
      { name: "Best Friends Animal Society — Emergency Response", desc: "National animal welfare organization deploying rescue and sheltering teams during wildfires, floods, and hurricanes.", url: "https://bestfriends.org/network/issues/emergency-response", icon: "🏠" },
      { name: "Alley Cat Allies — Disaster Resources", desc: "Feral and community cat disaster preparedness, evacuation, and shelter resources for caregivers and TNR colony managers.", url: "https://www.alleycat.org/resources/disaster-readiness/", icon: "🐈" },
      { name: "AVMA — Pet Disaster Preparedness", desc: "American Veterinary Medical Association guide for pet evacuation kits, identification, and emergency veterinary care during disasters.", url: "https://www.avma.org/resources-tools/healthy-pet-care/disaster-preparedness-pets", icon: "🏥" },
      { name: "FEMA — Include Pets in Emergency Plans", desc: "Official FEMA guidance on pet evacuation, emergency kits, and identifying pet-friendly shelters before disaster strikes.", url: "https://www.ready.gov/pets", icon: "🏛️" },
      { name: "Don't Forget the Pets", desc: "Disaster preparedness resources for pet owners and animal shelters — checklists, evacuation planning, and pet reunification guidance.", url: "https://dontforgetthepets.org/", icon: "🐾" },
      { name: "RedRover Urgent Care Grants", desc: "Financial assistance grants for families who cannot afford urgent veterinary care after a disaster or emergency.", url: "https://redrover.org/relief/urgent-care-grants/", icon: "💰" },
      { name: "American Humane — Disaster Response", desc: "American Humane deploys rescue teams for animals affected by disasters. Resources for pet owners and animal welfare organizations.", url: "https://www.americanhumane.org/", icon: "🇺🇸" },
      { name: "Greater Good — Disaster Relief", desc: "Greater Good Charity provides disaster relief for pets and people — food, supplies, and emergency funding for affected communities.", url: "https://greatergood.org/disaster", icon: "❤️" },
    ],
  },
  {
    id: "international",
    label: "International Emergency Resources",
    icon: Globe,
    color: "text-indigo-700",
    bg: "bg-indigo-50",
    border: "border-indigo-200",
    resources: [
      { name: "Get Prepared (Canada)", desc: "Government of Canada's official emergency preparedness portal — guides, checklists, and hazard-specific plans for Canadian families.", url: "https://www.getprepared.gc.ca/index-en.aspx", icon: "🇨🇦" },
      { name: "Canadian Red Cross", desc: "Disaster relief, shelter services, first aid training, and emergency preparedness across all Canadian provinces and territories.", url: "https://www.redcross.ca", icon: "🔴" },
      { name: "Public Safety Canada — Emergency Management", desc: "Federal coordination of emergency response, mitigation, and recovery. Hazard information and national disaster preparedness.", url: "https://www.publicsafety.gc.ca/cnt/mrgnc-mngmnt/index-en.aspx", icon: "🏛️" },
      { name: "Emergency Management Australia", desc: "Australian government agency coordinating disaster management, national emergency response, and recovery support.", url: "https://www.ema.gov.au", icon: "🇦🇺" },
      { name: "Australian Red Cross", desc: "Disaster relief, emergency services, and community resilience programs across Australia and the Pacific.", url: "https://www.redcross.org.au", icon: "🔴" },
      { name: "RSPCA Australia — Disaster Planning", desc: "Royal Society for the Prevention of Cruelty to Animals — disaster preparedness and emergency animal welfare resources for pet and livestock owners.", url: "https://www.rspca.org.au/what-we-do/disaster-planning", icon: "🐾" },
      { name: "IFRC Europe — Disaster Response", desc: "International Federation of Red Cross and Red Crescent Societies — disaster response across Eastern Europe and Central Asia.", url: "https://www.ifrc.org/regions/europe", icon: "🌍" },
      { name: "EU Civil Protection Mechanism", desc: "European Commission's Copernicus Emergency Management Service coordinating disaster response across all EU and participating states.", url: "https://emergency.copernicus.eu", icon: "🇪🇺" },
      { name: "Red Cross of Serbia", desc: "Disaster response, first aid training, and emergency social services in Serbia and the Balkans region.", url: "https://www.crvenikrst.rs/en/", icon: "🔴" },
      { name: "Polish Red Cross", desc: "Emergency response, disaster relief, and humanitarian assistance in Poland and neighboring Eastern European countries.", url: "https://www.pck.pl", icon: "🔴" },
      { name: "Romanian Red Cross", desc: "Disaster preparedness and response programs serving Romania and neighboring regions.", url: "https://www.crucearosie.ro", icon: "🔴" },
      { name: "Red Crescent — Central Asia", desc: "IFRC Red Crescent National Societies providing disaster response across Central Asian and Eastern European countries.", url: "https://www.ifrc.org/regions/europe", icon: "🌙" },
    ],
  },
  {
    id: "donations",
