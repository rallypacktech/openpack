  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      if (typeof pendo !== "undefined") {
        pendo.track("discord_connected");
      }
      toast.success(
        "Discord connected! Emergency alerts will now post to your channel.",
      );
    } catch (e) {
    ...
    <Card id="discord-connect">
      ...
      <CardContent className="space-y-4">
        <p className="text-sm text-muted-foreground">
          Connect a Discord channel to receive emergency alerts (evacuations,
          shelter openings, severe weather) using the same message template as
          email and Telegram. Each alert includes the original event timestamp
          and delivery attempt number so you can judge if information may be
          stale.
        </p>
        ...
        {isConnected ? (
          ...
          <div className="space-y-3">
            ...
            <div className="text-xs text-muted-foreground bg-muted/50 p-3 rounded-lg space-y-1">
              ...
              <p>
                2. Click <strong>Integrations</strong> →{" "}
                <strong>Webhooks</strong>
              </p>
              <p>
                3. Click <strong>New Webhook</strong>, pick a channel, then{" "}
