...
Deno.serve(async (req) => {
  try {
    ...
    for (const user of users) {
      ...
      body += `<p><a href="https://rallypack.org/Shopping" style="color:#222;">Shop now and mark items as owned</a></p><p>Stay safe,<br>The RallyPack Team</p><hr style="margin-top:30px;border:1px solid #ccc;"><p style="font-size:0.85em;color:#555;">You received this because you have a RallyPack account. To stop these reminders, update your notification settings.</p></body></html>`;
